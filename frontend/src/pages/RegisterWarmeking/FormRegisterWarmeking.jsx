...
const FormRegisterWarmeking = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Ganti endpoint API sesuai dengan backend Anda untuk warmeking
      await api.post("/warmeking", formData);
      setSubmitStatus({
        success: true,
        error: false,
        message: "Data warmeking berhasil disimpan!",
      });
      ...
      setSubmitStatus({
        ...
        message:
          ...
          "Terjadi kesalahan saat menyimpan data warmeking.",
      });
    } finally {
          ...
          <div className="p-6 sm:p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                  <label
                    htmlFor="permohonan_tentang"
                    className="block text-sm font-semibold text-gray-700 mb-2"
                  >
                    Permohonan Tentang <span className="text-rose-500">*</span>
                  </label>
                  <input
                    type="text"
                    name="permohonan_tentang"
                    id="permohonan_tentang"
                    value={formData.permohonan_tentang}
                    onChange={handleChange}
                    required
                    placeholder="Contoh: Penetapan Ahli Waris"
                ...
                <div>
                  <label
                    htmlFor="nama_pewaris"
                    className="block text-sm font-semibold text-gray-700 mb-2"
                  >
                    Nama Pewaris <span className="text-rose-500">*</span>
                  </label>
                  <input
                    type="text"
                    name="nama_pewaris"
                ...
                <div>
                  <label
                    htmlFor="nama_ahli_waris"
                    className="block text-sm font-semibold text-gray-700 mb-2"
                  >
                    Nama Ahli Waris <span className="text-rose-500">*</span>
                  </label>
                  <input
                    type="text"
...
export default FormRegisterWarmeking;
